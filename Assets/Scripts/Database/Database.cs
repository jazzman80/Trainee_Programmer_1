...
[CreateAssetMenu(fileName = "Database", menuName = "Create Database", order = 1)]

public class Database : ScriptableObject
{
    public List<Collection> collections = new List<Collection>();

    public void BuildDatabase(List<CollectionListResponse> collectionListResponse, List<CollectionElementResponse> collectionElementResponse)
    {
    ...
    public void UpdateFav(int collecttionIndex, int elementIndex, bool _isInFavorites)
    {
        collections[collecttionIndex].elements[elementIndex].isInFavorites = _isInFavorites;
    }
}
